        ...
        data: (team) {
          ...
          return Column(
            children: [
                ...
                child: Row(
                  children: List.generate(allAgents.length, (i) {
                    ...
                    return GestureDetector(
                      onTap: () => ref.read(_selectedAgentIndexProvider.notifier).state = i,
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected
                              ...
                              : Colors.transparent,
                          border: Border.all(
                            color: isSelected ? AppColors.neonBlue : AppColors.border,
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              agent.isOrchestrator ? Icons.hub_outlined : Icons.smart_toy_outlined,
                              color: isSelected ? AppColors.neonBlue : AppColors.border,
                              size: 14,
                            ),
                            ...
                            Text(
                              ...
                              style: AppTextStyles.label.copyWith(
                                color: isSelected ? AppColors.neonBlue : const Color(0xFF8892a4),
              ...
              // 🔹 Chat view do agente selecionado
              Expanded(
              ...
              SafeArea(
                ...
                child: MessageInput(
                onSend: (msg) {
                  // Envia via tmux send-keys
                  final session = selectedAgent.sessionName;
                  if (session != null && session.isNotEmpty) {
                    RawWsClient.sendInput(session, msg);
                  }
                  ref.read(teamNotifierProvider(teamId).notifier).sendMessage(msg);
                },
...
/// View de chat para um agente específico — conecta no WS e renderiza mensagens.
...
class _AgentChatViewState extends State<_AgentChatView> {
  ...
  void _selectOption(int index) {
    ...
    RawWsClient.selectOption(session, index, currentIndex: _activeMenu?.currentIndex ?? 1);
